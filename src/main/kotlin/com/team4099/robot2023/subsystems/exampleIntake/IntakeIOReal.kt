...
object IntakeIOReal : IntakeIO {
  ...
  private val intakeTalon = TalonFX(Constants.ExampleIntake.INTAKE_MOTOR)
  ...
  private val intakeSolenoid =
    Solenoid(PneumaticsModuleType.REVPH, Constants.ExampleIntake.ARM_SOLENOID)

  private val intakeSensor =
    ctreAngularMechanismSensor(
      intakeTalon,
      IntakeConstants.SENSOR_CPR,
